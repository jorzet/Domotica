...
public class FoundBTDevicesAdapter extends ArrayAdapter<BluetoothObject>
{
    ...
    {
        final BluetoothObject bluetoothObject = arrayFoundDevices.get(position);
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getContext(), "Dispositivo: "+bluetoothObject.getBluetooth_name(), Toast.LENGTH_LONG).show();
            }
        });
